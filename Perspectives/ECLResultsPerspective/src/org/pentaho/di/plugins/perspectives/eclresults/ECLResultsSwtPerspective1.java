 ...
 * Date: 1/6/11
 */
public class ECLResultsSwtPerspective1 implements SpoonPerspective {
  private Composite comp;
  private static ECLResultsSwtPerspective1 instance = new ECLResultsSwtPerspective1();
  ...
  private ECLResultsSwtPerspective1(){  
  ...
  /*
   TabFolder folder = new TabFolder(comp, SWT.NONE);
   folder.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, true, false));
   try{
   ...
   for(int i = 0; i<fileCount; i++){
       System.out.println("Tab Created ------");
        ...
        //create tabs
        System.out.println("Open File: " + System.getProperties().getProperty("fileName"+i));
        fileName =  System.getProperties().getProperty("fileName"+i);
        openFile(fileName);
        
        tab1.setControl(table);   
    }
    */
   //openFile(fileName);     
   //tab1.setControl(table);     
  ...
  public static ECLResultsSwtPerspective1 getInstance(){
  ...
  public void setActive(boolean b) {
      ...
      if(b){
         if(!this.isActive){
            ...
            try{
                System.out.println("FileCOunt: " + System.getProperties().getProperty("fileCount"));
               ...
               for(int i = 0; i<fileCount; i++){
                   System.out.println("Tab Created ------");
                      ...
                      Table table = new Table (group, SWT.VIRTUAL | SWT.BORDER);
                      table.setLinesVisible (true);
                      table.setHeaderVisible (true);
                      table.clearAll();
                      GridData data = new GridData(SWT.FILL, SWT.FILL, true, true);
