 ...
 * @author ChalaAX
 */
public class ECLML_ClassificationDialog extends JobEntryDialog implements JobEntryDialogInterface {

    private ECLML_Classification jobEntry;
    ...
    private Combo algType; //NaiveBayes, Logistic    
    ...
    public ECLML_ClassificationDialog(Shell parent, JobEntryInterface jobEntryInt, Repository rep, JobMeta jobMeta) {
        super(parent, jobEntryInt, rep, jobMeta);
        jobEntry = (ECLML_Classification) jobEntryInt;
        if (this.jobEntry.getName() == null) {
            this.jobEntry.setName("Classification");
        }
    }
    ...
    public JobEntryInterface open() {
        ...
        shell.setText("Define an ECL ML Classification");
        ...
        if (jobEntry.getAlgType() != null) {
            algType.setText(jobEntry.getAlgType());
        }
        
       
        if (jobEntry.getDependentVar() != null) {
            dependentVar.setText(jobEntry.getDependentVar());
        }
    ...
    //private Text independentVar; // 2
        ...
        jobEntry.setAlgType(algType.getText());
        jobEntry.setDependentVar(dependentVar.getText());
