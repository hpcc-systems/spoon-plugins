 ...
 * @author ChalaAX
 */
public class ECLML_BuildNaiveBayesDialog extends JobEntryDialog implements JobEntryDialogInterface {

    private ECLML_BuildNaiveBayes jobEntry;
    ...
    public ECLML_BuildNaiveBayesDialog(Shell parent, JobEntryInterface jobEntryInt, Repository rep, JobMeta jobMeta) {
        super(parent, jobEntryInt, rep, jobMeta);
        jobEntry = (ECLML_BuildNaiveBayes) jobEntryInt;
