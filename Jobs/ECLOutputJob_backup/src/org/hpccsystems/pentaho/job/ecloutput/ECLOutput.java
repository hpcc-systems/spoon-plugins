...
public class ECLOutput extends JobEntryBase implements Cloneable, JobEntryInterface {
                               ...
                               // System.out.println("--");
                                ...
                                for(int r = 0; r < al3Size ; r++){
                                    ...
                                    if(((Column)al3.get(r)).getName().equals("Name")){
                                        ...
                                        System.out.println(this.fileName + "_" + resName + ".csv");
                                        resName = resName.replace(" ", "_");
                                        createOutputFile(results,this.fileName + "_" + resName + ".csv",counter);
                                        counter++;
                                    }
                                }
    ...
    public String buildAndCheckSyntax(Result prevResult, int k) throws KettleException{
