 ...
 * @author KeshavS
 */
public class ECLGiniCoefficientDialog extends ECLJobEntryDialog{//extends JobEntryDialog implements JobEntryDialogInterface {
	
	public static final String NAME = "Name";
	public static final String INDEX = "Index";
	private ECLGiniCoefficient jobEntry;
    ...
    public ECLGiniCoefficientDialog(Shell parent, JobEntryInterface jobEntryInt, Repository rep, JobMeta jobMeta) {
        super(parent, jobEntryInt, rep, jobMeta);
        jobEntry = (ECLGiniCoefficient) jobEntryInt;
        if (this.jobEntry.getName() == null) {
            this.jobEntry.setName("GiniCoefficient");
        }
    }
    ...
    public JobEntryInterface open() {
        ...
        Output = buildText("Output Name :", Column, lsMod, middle, margin, fieldsGroup);    
