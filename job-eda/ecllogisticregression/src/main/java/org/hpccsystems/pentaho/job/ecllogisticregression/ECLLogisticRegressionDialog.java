 ...
 * @author KeshavS
 */
public class ECLLogisticRegressionDialog extends ECLJobEntryDialog{//extends JobEntryDialog implements JobEntryDialogInterface {
	
	public static final String NAME = "Name";
	public static final String DEP = "Dependance";
	public static final String INDEX = "Index";
	public static final String[] PROP = { NAME, DEP, INDEX };
    private ECLLogisticRegression jobEntry;
    ...
    public ECLLogisticRegressionDialog(Shell parent, JobEntryInterface jobEntryInt, Repository rep, JobMeta jobMeta) {
        super(parent, jobEntryInt, rep, jobMeta);
        jobEntry = (ECLLogisticRegression) jobEntryInt;
        if (this.jobEntry.getName() == null) {
            this.jobEntry.setName("LogisticRegression");
        }
    }
    ...
    public JobEntryInterface open() {
		...
		shell.setText("LogisticRegression");
        ...
        //Rsquared = buildCombo("Rsquared : ", datasetName, lsMod, middle, margin, fieldsGroup,new String[]{"YES","NO"});
        //Anova = buildCombo("Anova : ", Rsquared, lsMod, middle, margin, fieldsGroup,new String[]{"YES","NO"});	
        //Rsquared.setText("NO");
        //Anova.setText("NO");
        
        ModelName = buildText("Model Name :", datasetName , lsMod, middle, margin, fieldsGroup);
	   ...
	   /* Method.addModifyListener(new ModifyListener() {
            ...
            public void handleEvent(Event e) {
            	...
            	for(int i = 0; i<table.getItemCount(); i++){
            		...
            		if(S.equalsIgnoreCase("Dependant")){
            			depends = depends + 1;
            			dependantField = it.getText(0);
            			
            		}
            		else{
            			
            			independantFields.add(it.getText(0));
        ...
        if (jobEntry.getModelName() != null) {
            ModelName.setText(jobEntry.getModelName());
        }
        ...
        if (jobEntry.getdependantField()!= null) {
            dependantField = (jobEntry.getdependantField());
        }
            
        if (jobEntry.getIndependantFields() != null) {
            independantFields = (jobEntry.getIndependantFields());
        }
    ...
    private boolean validate(){
    	...
    	if(this.ModelName.getText().equals("")){
    		isValid = false;
    		errors += "\"Model Name\" is a required field!\r\n";
    	}
    ...
    private void ok() {
        ...
        jobEntry.setModelName(ModelName.getText());        
        jobEntry.setDatasetName(datasetName.getText());
        jobEntry.setFields(fields);
        jobEntry.setdependantField(dependantField);
        jobEntry.setIndependantFields(independantFields);
...
class PersonCellModifier implements ICellModifier {
	  ...
	  public Object getValue(Object element, String property) {
	    ...
	    if (ECLLogisticRegressionDialog.NAME.equals(property))
	      return p.getFirstName();
	    if (ECLLogisticRegressionDialog.DEP.equals(property))
		      return p.getDependance();
	    if (ECLLogisticRegressionDialog.INDEX.equals(property))
		      return p.getIndex();
	    else
	      return null;
	  }
	  ...
	  public void modify(Object element, String property, Object value) {
	    ...
	    else if (ECLLogisticRegressionDialog.DEP.equals(property))
