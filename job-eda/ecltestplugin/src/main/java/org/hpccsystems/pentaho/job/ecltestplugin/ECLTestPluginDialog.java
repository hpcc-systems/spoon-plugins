 ...
 * 
 */
public class ECLTestPluginDialog
    extends ECLJobEntryDialog
{

    private ECLTestPlugin jobEntry;
    ...
    public ECLTestPluginDialog(Shell parent, JobEntryInterface jobEntryInt, Repository rep, JobMeta jobMeta) {
        super(parent,jobEntryInt,rep,jobMeta);
        jobEntry = (ECLTestPlugin) jobEntryInt;
        if (this.jobEntry.getName() == null) {
        	this.jobEntry.setName("TestPlugin");
        }
    }
