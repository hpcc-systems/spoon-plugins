 ...
 * @author KeshavS
 */
public class ECLPValue extends ECLJobEntry{//extends JobEntryBase implements Cloneable, JobEntryInterface {
    ...
    public Result execute(Result prevResult, int k) throws KettleException {
        ...
        if(result.isStopped()){
        	...
        	PValue pval = new PValue();
        	pval.setDatasetName(getDatasetName());
        	pval.setValueOfX(getValueOfX());
        	pval.setOutput(getOutput());   
        	pval.setField(getField());
        	
        	    	
        	logBasic("PValueJob =" + pval.ecl());//{Dataset Job} 
	        
	        result.setResult(true);
	        
	        RowMetaAndData data = new RowMetaAndData();
	        data.addValue("ecl", Value.VALUE_TYPE_STRING, pval.ecl());
    ...
    public void loadXML(Node node, List<DatabaseMeta> list, List<SlaveServer> list1, Repository rpstr) throws KettleXMLException {
        try {
            ...
            if(XMLHandler.getNodeValue(XMLHandler.getSubNode(node, "valueOfX")) != null)
            	setValueOfX(XMLHandler.getNodeValue(XMLHandler.getSubNode(node, "valueOfX")));
    ...
    public String getXML() {
        ...
        retval += "		<valueOfX><![CDATA[" + valueOfX + "]]></valueOfX>" + Const.CR;
    ...
    public void loadRep(Repository rep, ObjectId id_jobentry, List<DatabaseMeta> databases, List<SlaveServer> slaveServers)
        ...
        try {
            ...
            if(rep.getStepAttributeString(id_jobentry, "valueOfX") != null)
            	valueOfX = rep.getStepAttributeString(id_jobentry, "valueOfX"); //$NON-NLS-1$ 
    ...
    public void saveRep(Repository rep, ObjectId id_job) throws KettleException {
        try {
            ...
            rep.saveStepAttribute(id_job, getObjectId(), "valueOfX", valueOfX); //$NON-NLS-1$
