 ...
 * @author ChambersJ
 */
public class ECLFStatistic extends ECLJobEntry{//extends JobEntryBase implements Cloneable, JobEntryInterface {
...
/*
  ...
  */  
    ...
    public Result execute(Result prevResult, int k) throws KettleException {
        ...
        fstat.setName(getName());
//        fstat.setName(getRecordsetName());
        System.out.println("------------------- GET RECORDS ------------------");
        String columnlist = recordListToSortECL();
        
        StringTokenizer stk = new StringTokenizer(columnlist,",");
        ArrayList<String> column_array = new ArrayList<String>();
        
        while (stk.hasMoreTokens()){
        	column_array.add(stk.nextToken());
    
        }
        fstat.setFields(column_array);
        logBasic("{Sort Job} Execute = " + fstat.ecl());
        ...
        data.addValue("ecl", Value.VALUE_TYPE_STRING, fstat.ecl());
