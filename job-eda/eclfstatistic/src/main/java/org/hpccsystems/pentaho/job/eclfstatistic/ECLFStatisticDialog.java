 ...
 * @author ChambersJ
 */
public class ECLFStatisticDialog extends ECLJobEntryDialog{//extends JobEntryDialog implements JobEntryDialogInterface {

    private ECLFStatistic jobEntry;
    ...
    public ECLFStatisticDialog(Shell parent, JobEntryInterface jobEntryInt, Repository rep, JobMeta jobMeta) {
        super(parent, jobEntryInt, rep, jobMeta);
        jobEntry = (ECLFStatistic) jobEntryInt;
    ...
    public JobEntryInterface open() {
    	...
    	// **********gagan
    	createTableObject.setBtnUp(false);
    	createTableObject.setBtnDwn(false);
        ...
        shell.setText("Define an ECL fstatistic");
       ...
       // this.datasetName = buildCombo("Dataset to be Sorted", recordsetName, lsMod, middle, margin, joinGroup, datasets);
        this.datasetName = buildCombo("Dataset to be Sorted", null, lsMod, middle, margin, joinGroup, datasets);
        ...
        */
		...
		TabItem item2 = createTableObject.buildDefTab("F-Statistics", tabFolder);
