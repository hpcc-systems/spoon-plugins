...
import org.hpccsystems.javaecl.CheckResult;
import org.hpccsystems.javaecl.EclCommand;

*//**
 *
 * @author ChalaAX
 *//*
public class FStatistic implements EclCommand {
    ...
    public String ecl() {
        ...
        String ecl ="";
        ECLUnivariate eclUnvariate = new ECLUnivariate();
        ...
        eclUnvariate = new ECLUnivariate();
        eclUnvariate.setCheckList("true,fa,fa,fa,af,af,af");
